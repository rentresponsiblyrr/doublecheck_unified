    ...
    try {
      ...
      for (const action of highPriorityActions) {
        try {
          ...
          logger.warn(
            `Recovery action ${action.id} failed`,
            actionError,
            "MOBILE_ERROR_RECOVERY",
          );
        }
      ...
      toast({
        ...
        description:
          "Automatic recovery process has completed. Please try your action again.",
        duration: 5000,
      });
    } catch (error) {
      ...
      toast({
        ...
        description:
          "Automatic recovery was unsuccessful. Please try manual steps.",
        variant: "destructive",
      });
    } finally {
