...
export type WorkflowEvent =
  ...
  | {
      ...
      payload: { propertyData: Record<string, unknown> };
    }
    ...
    case "idle":
      if (event.type === "START_PROPERTY_CREATION") {
        return {
          ...
          history: [
            ...current.history,
            { state: "property_creation", timestamp, event },
          ],
        };
      }
      break;
    ...
    case "property_creation":
      if (event.type === "PROPERTY_CREATED") {
        return {
          ...
          history: [
            ...current.history,
            { state: "property_creation_complete", timestamp, event },
          ],
        };
      }
      break;
    ...
    case "property_creation_complete":
      if (event.type === "START_SCRAPING") {
        return {
          ...
          history: [
            ...current.history,
            { state: "scraping_initiated", timestamp, event },
          ],
        };
      }
      if (event.type === "SELECT_PROPERTY") {
        return {
          ...
          history: [
            ...current.history,
            { state: "property_selection", timestamp, event },
          ],
        };
      }
      break;
    ...
    case "scraping_in_progress":
      if (event.type === "SCRAPING_PROGRESS") {
        return {
          ...
          history: [
            ...current.history,
            { state: "scraping_in_progress", timestamp, event },
          ],
        };
      }
      if (event.type === "SCRAPING_SUCCESS") {
        return {
          ...
          history: [
            ...current.history,
            { state: "scraping_complete", timestamp, event },
          ],
        };
      }
      if (event.type === "SCRAPING_FAILED") {
        return {
          ...
          history: [
            ...current.history,
            { state: "scraping_failed", timestamp, event },
          ],
        };
      }
      break;
    ...
    case "property_selection":
      if (event.type === "SELECT_PROPERTY") {
        return {
          ...
          history: [
            ...current.history,
            { state: "property_selected", timestamp, event },
          ],
        };
      }
      break;
    ...
    case "property_selected":
      if (event.type === "CREATE_INSPECTION") {
        return {
          ...
          history: [
            ...current.history,
            { state: "inspection_creation", timestamp, event },
          ],
        };
      }
      break;
    ...
    case "inspection_creation":
      if (event.type === "INSPECTION_CREATED") {
        return {
          ...
          history: [
            ...current.history,
            { state: "inspection_ready", timestamp, event },
          ],
        };
      }
      break;
    ...
    case "inspection_ready":
      if (event.type === "START_INSPECTION") {
        return {
          ...
          history: [
            ...current.history,
            { state: "inspection_started", timestamp, event },
          ],
        };
      }
      break;
    ...
    if (machine.state === "scraping_complete") {
      const timer = setTimeout(() => {
        dispatch({
          ...
          payload: { propertyId: machine.context.propertyId || "" },
        });
      }, 1000);
