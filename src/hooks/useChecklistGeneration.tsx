...
export const useChecklistGeneration = ({
  ...
  const categorizeExistingChecklist = useCallback(() => {
    ...
    const static_items = generatedChecklist.filter(
  ...
  const generateAIItems = useCallback((property: Property): ChecklistItem[] => {
    ...
    if (
      property.property_name.toLowerCase().includes("beach") ||
    ...
    aiItems.push({
      ...
      evidence_type: "photo",
      description:
        "AI-enhanced: Verify all kitchen appliances are safe and functional",
      ai_generated: true,
    });
    ...
    aiItems.push({
      ...
      evidence_type: "photo",
      description:
        "AI-enhanced: Check bathroom ventilation and moisture control",
      ai_generated: true,
    });
  ...
  const generateChecklist = useCallback(async () => {
    try {
      ...
      toast({
        ...
        description:
          "Failed to generate inspection checklist. Using default items.",
        variant: "destructive",
      });
