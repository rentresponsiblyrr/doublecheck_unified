...
import { testComponentAccessibility, testErrorStateAccessibility } from './axe-setup';
...
describe('PropertySelector Accessibility Tests', () => {
  ...
  describe('WCAG 2.1 AA Compliance', () => {
    ...
    it('should have accessible form with proper labels', async () => {
      ...
      const addButton = screen.getByRole('button', { name: /open add property form/i });
  ...
  describe('Keyboard Navigation', () => {
    it('should support keyboard navigation through all interactive elements', async () => {
      ...
      const propertyCard = screen.getByRole('button', { name: /select property/i });
  ...
  describe('Error State Accessibility', () => {
    ...
    it('should provide accessible error recovery options', async () => {
      ...
      const retryButton = screen.getByRole('button', { name: /retry loading properties/i });
      const addButton = screen.getByRole('button', { name: /add new property instead/i });
  ...
  describe('Loading State Accessibility', () => {
    it('should have accessible loading indicators', () => {
      ...
      const loadingRegion = screen.getByRole('status', { name: /loading properties/i });
