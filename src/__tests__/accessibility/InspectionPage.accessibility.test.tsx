...
vi.mock('@/components/InspectionLoadingState', () => ({
  InspectionLoadingState: () => <div data-testid="loading-state">Loading...</div>
}));

vi.mock('@/components/InspectionContent', () => ({
  InspectionContent: () => <div data-testid="inspection-content">Inspection Content</div>
}));
...
const TestWrapper = ({ children, route = '/inspection/test-id' }: { children: React.ReactNode; route?: string }) => (
...
describe('InspectionPage Error Handling Accessibility Tests', () => {
  ...
  describe('Invalid Inspection ID Error State', () => {
    ...
    it('should have proper error alert structure for missing ID', async () => {
      ...
      expect(main).toHaveAttribute('aria-labelledby', 'invalid-inspection-title');
    ...
    it('should have accessible navigation button for missing ID', async () => {
      ...
      const button = screen.getByRole('button', { name: /return to properties page/i });
  ...
  describe('Authentication Error States', () => {
    it('should handle authentication loading state accessibly', async () => {
      ...
      const status = screen.getByRole('status', { name: /authentication in progress/i });
    ...
    it('should provide accessible error recovery options for auth errors', async () => {
      ...
      const retryButton = screen.getByRole('button', { name: /retry authentication/i });
      const returnButton = screen.getByRole('button', { name: /return to properties page without retrying/i });
    ...
    it('should handle unauthenticated state accessibly', async () => {
      ...
      const button = screen.getByRole('button', { name: /go to sign in page/i });
      expect(button).toHaveAttribute('aria-label');
  ...
  describe('Keyboard Navigation', () => {
    it('should support keyboard navigation on error recovery buttons', async () => {
      ...
      const retryButton = screen.getByRole('button', { name: /retry authentication/i });
      const returnButton = screen.getByRole('button', { name: /return to properties page/i });
...
describe('SimplifiedInspectionPage Accessibility Tests', () => {
  ...
  describe('Fixed Broken Code Accessibility', () => {
    ...
    it('should have working authentication error recovery', async () => {
      ...
      const returnButton = screen.getByRole('button', { name: /return to properties/i });
