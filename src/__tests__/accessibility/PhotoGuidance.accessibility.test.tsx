...
import { testComponentAccessibility, testInteractiveAccessibility } from './axe-setup';
...
vi.mock('@/hooks/useCamera', () => ({
  useCamera: () => ({
    ...
    stopCamera: vi.fn(),
    switchCamera: vi.fn(),
    takePhoto: vi.fn().mockResolvedValue(new Blob(['test'], { type: 'image/jpeg' }))
  })
}));
...
describe('PhotoGuidance Accessibility Tests', () => {
  ...
  describe('Keyboard Navigation', () => {
    ...
    it('should handle Escape key for guidance collapse', async () => {
      ...
      // Open guidance first
      const guidanceButton = screen.getByRole('button', { name: /show guidance/i });
  ...
  describe('Screen Reader Support', () => {
    ...
    it('should have proper form instructions', () => {
      ...
      const instructions = screen.getByText(/use the capture button or press space/i);
  ...
  describe('Error State Accessibility', () => {
    ...
    it('should provide alternative actions on error', () => {
      ...
      const continueButton = screen.getByRole('button', { name: /continue without camera/i });
