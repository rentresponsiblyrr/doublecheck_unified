...
export const ProfileFactory = Factory.define(() => ({
  ...
  role: faker.helpers.arrayElement(["inspector", "auditor", "admin"]) as
    | "inspector"
    | "auditor"
    | "admin",
...
export const MediaFactory = Factory.define(() => ({
  ...
  upload_status: faker.helpers.arrayElement([
    "pending",
    "uploading",
    "completed",
    "failed",
...
export const ErrorDetailsFactory = Factory.define(() => ({
  ...
  level: faker.helpers.arrayElement(["error", "warn", "info"]) as
    | "error"
    | "warn"
    | "info",
...
export const ApiResponseFactory = Factory.define(() => ({
  ...
  statusText: faker.helpers.arrayElement([
    "OK",
    "Created",
    "Bad Request",
    "Unauthorized",
...
export const PerformanceMetricsFactory = Factory.define(() => ({
  ...
  metrics: {
    ...
    cumulativeLayoutShift: faker.number.float({
      min: 0,
      max: 0.5,
      fractionDigits: 3,
    }),
...
export const TestDataUtils = {
  ...
  createInspectionWorkflow: () => {
    ...
    const safetyItems = Array.from({ length: 5 }, () =>
