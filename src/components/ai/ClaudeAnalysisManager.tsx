    ...
    try {
      ...
      const mockResult: AnalysisResult = {
        analysis: {
          ...
          confidence: 0.75,
          reasoning: 'Mock photo analysis would be performed here. Claude AI would analyze property inspection photos for safety compliance, identify issues, and provide recommendations.',
          issues: [
    ...
    try {
      ...
      const mockResult: AnalysisResult = {
        review: {
          ...
          issues: [
            {
              ...
              description: 'Mock: Input validation could be improved for better security',
          ...
          summary: 'Mock code review completed. Overall code quality is good with some areas for improvement in security and performance.'
        },
        usage: {
          inputTokens: 200,
          outputTokens: 150,
