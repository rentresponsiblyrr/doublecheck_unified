 ...
 */
export const PropertyInspectionStatus: React.FC<PropertyInspectionStatusProps> = ({
  activeInspection,
  lastWorkTime,
  className = ''
}) => {
    ...
    >
      ...
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center">
          <PlayCircle className="w-4 h-4 text-blue-600 mr-2" aria-hidden="true" />
          <span className="font-medium text-blue-900">Inspection In Progress</span>
          <div className="ml-2">
            {getStatusBadge(activeInspection.status)}
          </div>
        </div>
        {lastWorkTime && (
      ...
      <div className="mb-2" id={`progress-section-${activeInspection.id}`}>
        <div className="flex items-center justify-between text-xs text-blue-700 mb-1">
          ...
          <span>
            {activeInspection.completed_items}/{activeInspection.total_items} items
          </span>
        </div>
        <Progress 
      ...
      <div className="flex items-center justify-between text-xs text-blue-600">
        ...
        <div className="flex items-center">
          ...
          <span>
            {activeInspection.photos_captured}/{activeInspection.photos_required} photos
          </span>
        </div>
      </div>
    </div>
