...
const InspectionComplete = React.lazy(
  () => import("../pages/InspectionComplete"),
);
...
function ProfessionalLoadingFallback({
  message = "Loading...",
}: {
  message?: string;
}) {
        ...
        element={
          <ProtectedRoute requiredRole="inspector">
            <ErrorBoundary level="component">
              <Suspense
                fallback={
                  <ProfessionalLoadingFallback message="Loading property dashboard..." />
                }
              >
                <PropertySelection />
              </Suspense>
        ...
        element={
          <ProtectedRoute requiredRole="inspector">
            <ErrorBoundary level="component">
              <Suspense
                fallback={
                  <ProfessionalLoadingFallback message="Loading inspector workflow..." />
                }
              >
                <InspectorWorkflow />
              </Suspense>
        ...
        element={
          <ProtectedRoute requiredRole="inspector">
            <ErrorBoundary level="component">
              <Suspense
                fallback={
                  <ProfessionalLoadingFallback message="Loading properties..." />
                }
              >
                <PropertySelection />
              </Suspense>
        ...
        element={
          <ProtectedRoute requiredRole="inspector">
            <ErrorBoundary level="component">
              <Suspense
                fallback={
                  <ProfessionalLoadingFallback message="Loading property form..." />
                }
              >
                <AddProperty />
              </Suspense>
        ...
        element={
          <ProtectedRoute requiredRole="inspector">
            <ErrorBoundary level="component">
              <Suspense
                fallback={
                  <ProfessionalLoadingFallback message="Loading dashboard..." />
                }
              >
                <Index />
              </Suspense>
        ...
        element={
          <ProtectedRoute requiredRole="inspector">
            <ErrorBoundary level="component">
              <Suspense
                fallback={
                  <ProfessionalLoadingFallback message="Loading inspection reports..." />
                }
              >
                <InspectionReports />
              </Suspense>
        ...
        element={
          <ProtectedRoute requiredRole="inspector">
            <ErrorBoundary level="component">
              <Suspense
                fallback={
                  <ProfessionalLoadingFallback message="Loading inspection..." />
                }
              >
                <InspectionPage />
              </Suspense>
        ...
        element={
          <ProtectedRoute requiredRole="inspector">
            <ErrorBoundary level="component">
              <Suspense
                fallback={
                  <ProfessionalLoadingFallback message="Loading completion page..." />
                }
              >
                <InspectionComplete />
              </Suspense>
        ...
        element={
          <ProtectedRoute requiredRole="admin">
            <ErrorBoundary level="component">
              <Suspense
                fallback={
                  <ProfessionalLoadingFallback message="Loading admin portal..." />
                }
              >
                <DirectAdminRouter />
              </Suspense>
              ...
              <div className="min-h-screen bg-gray-50 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    The auditor interface is now part of the admin portal.
                  </p>
                  <button
