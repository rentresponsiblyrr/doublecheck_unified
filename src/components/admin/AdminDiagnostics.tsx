    ...
    const componentTests = [
      {
        ...
        test: () => import("./SimpleUserManagement"),
      },
      {
        name: "SimpleChecklistManagement",
        test: () => import("./SimpleChecklistManagement"),
      },
    ...
    <div className="space-y-6">
      ...
      {failCount > 0 && (
        <Alert variant="destructive">
          ...
          <AlertDescription>
            <strong>{failCount} critical issues found.</strong> The admin
            components may not work properly until these are resolved.
          </AlertDescription>
        </Alert>
      )}
    </div>
