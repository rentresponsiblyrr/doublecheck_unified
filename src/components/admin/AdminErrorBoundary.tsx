  ...
  public render() {
    if (this.state.hasError) {
      ...
      if (isConfigError) {
        ...
        errorDescription =
          "System configuration is being updated. Please try again.";
      } else if (isNetworkError || isRPCError) {
        errorTitle = "Connection Issue";
        errorDescription =
          "Unable to connect to admin services. Please check your connection.";
      }
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex flex-col space-y-2">
                {this.retryCount < this.maxRetries && (
                  ...
                  >
                    <RefreshCw
                      className={`h-4 w-4 mr-2 ${this.state.isClearing ? "animate-spin" : ""}`}
                    />
                ...
                {this.state.error &&
                  cacheManager.shouldClearCaches(this.state.error) && (
                    <Button
