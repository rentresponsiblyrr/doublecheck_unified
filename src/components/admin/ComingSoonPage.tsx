...
import { Clock, Rocket, CheckCircle, Calendar, Mail, Bell } from "lucide-react";
        ...
        <div className="text-center space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <p className="text-xs text-blue-700 mb-3">
              We'll send you an email as soon as {title.toLowerCase()} is ready
              to use.
            </p>
            {onNotifyMe ? (
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "mailto:support@doublecheckverified.com?subject=Feature Request Notification",
                    "_blank",
                  )
                }
              >
