    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        <div className="flex items-center space-x-2">
          <Checkbox
            ...
            onCheckedChange={(checked) => onUpdateDeliveryOption('includeReport', checked)}
          />
        ...
        <div className="flex items-center space-x-2">
          <Checkbox
            ...
            onCheckedChange={(checked) => onUpdateDeliveryOption('includePhotos', checked)}
          />
        ...
        <div className="flex items-center space-x-2">
          <Checkbox
            ...
            onCheckedChange={(checked) => onUpdateDeliveryOption('includeRecommendations', checked)}
          />
        ...
        <div className="flex items-center space-x-2">
          <Checkbox
            ...
            onCheckedChange={(checked) => onUpdateDeliveryOption('urgentIssues', checked)}
          />
        ...
        <div className="flex items-center space-x-2">
          <Checkbox
            ...
            onCheckedChange={(checked) => onUpdateDeliveryOption('followUpRequired', checked)}
          />
      ...
      <div className="space-y-2">
        ...
        <Select 
          ...
          onValueChange={(value) => onUpdateDeliveryOption('deliveryMethod', value)}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
