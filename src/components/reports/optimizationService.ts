  ...
  static generateSuggestions(propertyId: string): OptimizationSuggestion[] {
    ...
    if (photoScore < 85) {
      suggestions.push({
        ...
        description:
          "High-quality photos are crucial for attracting bookings and setting proper expectations.",
    ...
    if (pricingScore < 85) {
      suggestions.push({
        ...
        description:
          "Competitive pricing analysis suggests room for optimization to maximize revenue.",
    ...
    if (amenityScore < 85) {
      suggestions.push({
        ...
        description:
          "Additional amenities and better presentation can justify higher pricing.",
    ...
    suggestions.push({
      ...
      description:
        "A compelling description with the right keywords improves search visibility.",
      impact:
        "Optimized descriptions can improve search ranking and conversion rates",
      actionItems: [
    ...
    if (safetyScore < 90) {
      suggestions.push({
        ...
        description:
          "Safety improvements protect guests and reduce liability concerns.",
        impact:
          "Better safety features can improve guest confidence and reviews",
        actionItems: [
