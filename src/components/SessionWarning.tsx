  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
        <div
          className={`bg-white rounded-lg shadow-2xl border-2 ${getUrgencyColor()} max-w-md w-full`}
        >
          <div className="p-6">
            {/* Header */}
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-600 text-center">
                Click "Stay Logged In" to continue your session, or "Logout Now"
                to logout immediately.
              </p>
            </div>
            ...
            <div className="mt-4 text-xs text-gray-500 text-center">
              <p>
                For security, sessions automatically expire after periods of
                inactivity.
              </p>
            </div>
          </div>
