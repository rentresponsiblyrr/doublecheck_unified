...
> {
  ...
  private promiseRejectionHandler:
  ...
  private detectOperationType(
    error: Error,
  ): AsyncErrorBoundaryState["operationType"] {
  ...
  private determineRecoveryStrategy(
    error: Error,
  ): AsyncErrorBoundaryState["recoveryStrategy"] {
    const message = error.message.toLowerCase();
        ...
        <Card id="async-error-card" className="border-red-200">
          <CardHeader id="async-error-header" className="text-center">
            ...
            >
              ...
              <Badge
                variant={
                  networkStatus === "offline" ? "destructive" : "secondary"
                }
                className="text-xs"
              >
          ...
          <CardContent
            id="async-error-content"
            className="text-center space-y-4"
          >
            <p className="text-gray-600 text-sm">{this.getErrorMessage()}</p>
        ...
        <Card id="offline-card" className="border-orange-200 bg-orange-50">
          ...
          <CardContent className="text-center space-y-4">
            <p className="text-orange-700 text-sm">
              Some features may be limited while offline. We'll sync your
...
export function useAsyncErrorHandler() {
  const [asyncErrorBoundary, setAsyncErrorBoundary] =
