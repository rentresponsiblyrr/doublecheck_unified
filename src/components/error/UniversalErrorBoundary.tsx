...
export class UniversalErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render() {
    ...
    const { customFallback, fallbackStrategy = 'retry', level = 'component', maxRetries = 3 } = this.props;
      ...
      <Card className="border-red-200 bg-red-50">
        <CardContent className="p-6 text-center">
          <div id="error-boundary-redirect">
            ...
            <p className="text-gray-600 mb-4">
              This page encountered an error. You've been redirected to a safe state.
            </p>
...
export const ComponentErrorBoundary: React.FC<{ children: ReactNode }> = ({ children }) => (
  <UniversalErrorBoundary level="component" fallbackStrategy="retry" maxRetries={3}>
    {children}
  </UniversalErrorBoundary>
);

export const FormErrorBoundary: React.FC<{ children: ReactNode }> = ({ children }) => (
  <UniversalErrorBoundary level="form" fallbackStrategy="minimal" maxRetries={1}>
    {children}
  </UniversalErrorBoundary>
);
