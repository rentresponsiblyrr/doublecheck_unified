...
export const PhotoCaptureAdditionalControls: React.FC<PhotoCaptureAdditionalControlsProps> = ({
  onSettings,
  onSave,
  className
}) => {
  return (
    <div className={`flex justify-center gap-4 text-sm text-gray-600 ${className}`} id="photo-capture-additional-controls">
      <button 
