...
export const VideoPreview: React.FC<VideoPreviewProps> = ({
  ...
  if (error) {
    return (
      <div id="video-error-state" className="aspect-video bg-gray-100 rounded-lg flex items-center justify-center">
  ...
  if (isLoading) {
    return (
      <div id="video-loading-state" className="aspect-video bg-gray-100 rounded-lg flex items-center justify-center">
  ...
  if (!hasPermission) {
    return (
      <div id="video-permission-state" className="aspect-video bg-gray-100 rounded-lg flex items-center justify-center">
        <div className="text-center text-gray-600">
          <FileVideo className="w-12 h-12 mx-auto mb-2" />
          <p className="text-sm">Camera permission required</p>
          <p className="text-xs mt-1">Please allow camera access to record video</p>
        </div>
      </div>
    );
  }
