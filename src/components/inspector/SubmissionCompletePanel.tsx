...
export const SubmissionCompletePanel: React.FC<
  SubmissionCompletePanelProps
> = ({
  selectedProperty,
  inspectionId,
  completedItemsCount,
    ...
    <Card>
      <CardContent className="p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">
          Your inspection for "{selectedProperty?.property_name}" has been
        ...
        <Button onClick={onNewInspection}>Start New Inspection</Button>
      </CardContent>
    </Card>
  );
};
