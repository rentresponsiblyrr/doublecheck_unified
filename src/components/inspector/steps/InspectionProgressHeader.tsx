 ...
 */
const calculateProgress = (steps: InspectionStep[], overallProgress?: number): number => {
 ...
 */
export const InspectionProgressHeader: React.FC<InspectionProgressHeaderProps> = ({
  propertyName,
  steps,
  overallProgress,
  className = ''
