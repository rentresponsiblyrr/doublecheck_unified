...
type PWAAction =
  ...
  | {
      ...
      payload: Partial<PushNotificationStatus>;
    };
...
export const PWAProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const initializePushNotifications =
    async (): Promise<PushNotificationStatus> => {
    ...
    () => ({
      initializePWA: async () => {
        try {
          ...
          logger.info(
            "🚀 Initializing unified PWA state management",
            {},
            "PWA_CONTEXT",
          );
          ...
          logger.info(
            "✅ PWA state management initialized successfully",
            {
          ...
          logger.error(
            "❌ PWA state management initialization failed",
            { error },
            "PWA_CONTEXT",
          );
