...
export class ClaudeClient {
   ...
   */
  async analyzeInspectionPhoto(request: Omit<ClaudeAnalysisRequest, 'analysisType'>): Promise<ClaudeAnalysisResponse> {
    ...
    if (error) {
      throw new Error(`Claude photo analysis failed: ${error.message || 'Unknown error'}`);
    }
   ...
   */
  async generateText(request: Omit<ClaudeAnalysisRequest, 'analysisType'>): Promise<ClaudeAnalysisResponse> {
    ...
    if (error) {
      throw new Error(`Claude text generation failed: ${error.message || 'Unknown error'}`);
    }
   ...
   */
  async reviewCode(request: Omit<ClaudeAnalysisRequest, 'analysisType'>): Promise<ClaudeAnalysisResponse> {
    ...
    if (error) {
      throw new Error(`Claude code review failed: ${error.message || 'Unknown error'}`);
    }
