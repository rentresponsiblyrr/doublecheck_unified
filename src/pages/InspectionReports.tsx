    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Loading Reports</h1>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">No Reports Available</h1>
          <p className="text-gray-600 mb-4">
            Complete your first inspection to see detailed reports and analytics here.
          </p>
          <Button 
            onClick={() => navigate('/')} 
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Track your inspection history and performance</p>
            </div>
            <Button
              onClick={() => navigate('/')}
              variant="outline"
          ...
          <CardContent>
            {filteredInspections.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 mb-4">No inspections match your current filters</p>
                <Button 
                  onClick={() => {
                    setSearchTerm('');
                    setStatusFilter('all');
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          <h3 className="font-semibold text-lg">{inspection.property_name}</h3>
                          {getStatusBadge(inspection.status)}
                        </div>
                        <p className="text-gray-600 text-sm mb-2">{inspection.property_address}</p>
                        <div className="flex items-center space-x-4 text-sm text-gray-500">
                          ...
                          <div className="flex items-center space-x-1">
                            ...
                            <span>{formatDuration(inspection.duration_minutes)}</span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-3">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm">
                          {inspection.completed_items || 0}/{inspection.total_items || 0} Items
                        </span>
                      </div>
                    </div>
                    ...
                    {inspection.total_items > 0 && (
                      <div className="mt-3">
                        <div className="flex justify-between text-sm text-gray-600 mb-1">
                          <span>Progress</span>
                          <span>{Math.round(((inspection.completed_items || 0) / inspection.total_items) * 100)}%</span>
                        </div>
