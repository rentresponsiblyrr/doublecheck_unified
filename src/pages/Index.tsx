        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <Card className="cursor-pointer hover:shadow-lg transition-shadow">
            <CardHeader>
              ...
              <CardDescription>View inspection reports and analytics</CardDescription>
            </CardHeader>
            <CardContent>
              <Button variant="outline" className="w-full">
                View Reports
                  ...
                  <div key={inspection.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50 transition-colors">
                    <div className="flex-1">
                      <div className="flex items-center space-x-3 mb-2">
                        <h3 className="font-medium">{inspection.property?.name || 'Unnamed Property'}</h3>
                        {getStatusBadge(inspection.status)}
                      </div>
                      <p className="text-sm text-gray-600 mb-1">
                        <MapPin className="h-4 w-4 inline mr-1" />
                        {inspection.property?.address || 'Address not available'}
                      </p>
