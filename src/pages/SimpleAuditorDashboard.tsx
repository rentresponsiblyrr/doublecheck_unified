...
export default function SimpleAuditorDashboard() {
  ...
  const metrics = React.useMemo(() => {
    ...
    const pendingReviews = inspections.filter(
      (i) => i.status === "completed" || i.status === "pending_review",
    ).length;
    const completedToday = inspections.filter((i) => {
      const createdDate = new Date(i.created_at);
      createdDate.setHours(0, 0, 0, 0);
      return (
        createdDate.getTime() === today.getTime() && i.status === "completed"
      );
    }).length;
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Review and manage property inspections
              </p>
            </div>
            ...
            <TabsContent value="inspections">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Review and approve property inspections from field
                    inspectors
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {loadingInspections ? (
                    ...
                    <div className="text-center py-8">
                      ...
                      <p className="text-sm text-gray-400">
                        Inspections will appear here once created
                      </p>
                    </div>
                  ) : (
                ...
                <CardContent>
                  <div className="flex items-center justify-center h-64 text-gray-500">
                    <div className="text-center">
                      ...
                      <p className="text-sm">
                        PDF and Excel export options available
                      </p>
