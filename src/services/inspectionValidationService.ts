...
export class InspectionValidationService {
  static async validatePropertyAccess(propertyId: string): Promise<boolean> {
    try {
      ...
      log.info(
        "Property access validated successfully",
        {
          component: "InspectionValidationService",
          action: "validatePropertyAccess",
          propertyId,
      ...
      log.error(
        "Property access validation failed",
        error as Error,
        {
          component: "InspectionValidationService",
          action: "validatePropertyAccess",
  ...
  static async verifyChecklistItemsCreated(
    ...
    try {
      log.info(
        "Verifying checklist items creation",
        {
          component: "InspectionValidationService",
      ...
      if (inspectionError) {
        log.error(
          "Error getting inspection for checklist verification",
          inspectionError,
          {
            component: "InspectionValidationService",
            action: "verifyChecklistItemsCreated",
      ...
      if (!inspectionData) {
        log.error(
          "Inspection not found for checklist verification",
          null,
          {
            component: "InspectionValidationService",
            action: "verifyChecklistItemsCreated",
      ...
      if (error) {
        log.error(
          "Error verifying checklist items",
          error,
          {
            component: "InspectionValidationService",
            action: "verifyChecklistItemsCreated",
      ...
      log.info(
        "Checklist items verification completed",
        {
          component: "InspectionValidationService",
          action: "verifyChecklistItemsCreated",
          inspectionId,
      ...
      if (count === 0) {
        log.warn(
          "No checklist items found - trigger may have failed",
          {
            component: "InspectionValidationService",
            action: "verifyChecklistItemsCreated",
            inspectionId,
      ...
      log.error(
        "Failed to verify checklist items",
        error as Error,
        {
          component: "InspectionValidationService",
          action: "verifyChecklistItemsCreated",
