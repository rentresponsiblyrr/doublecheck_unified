    ...
    subscribeWithSelector(
      immer((set, get) => ({
        ...
        validateForm: () => {
          ...
          const validSteps = state.formData.reproductionSteps.filter((step) =>
            step.trim(),
          );
        ...
        startScreenshotCapture: async () => {
          try {
            ...
            const { screenshotCaptureService } = await import(
              "@/utils/screenshotCapture"
            );
        ...
        submitBugReport: async () => {
          try {
            ...
            const { intelligentBugReportService } = await import(
              "@/services/intelligentBugReportService"
            );
            const { githubIssuesService } = await import(
              "@/services/githubIssuesService"
            );
            ...
            const intelligentReport =
              await intelligentBugReportService.generateIntelligentReport({
