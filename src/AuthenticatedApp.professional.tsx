...
const ProfessionalPageLoader: React.FC<{ page?: string }> = ({ page = 'page' }) => (
            ...
            >
              <Routes>
                ...
                <Route 
                  ...
                  element={
                    <ProtectedRoute roles={['inspector']}>
                      <ProfessionalRoute component={InspectorDashboard} name="Dashboard" />
                    </ProtectedRoute>
                  } 
                />
                ...
                <Route 
                  ...
                  element={
                    <ProtectedRoute roles={['inspector']}>
                      <ProfessionalRoute component={PropertySelection} name="Properties" />
                    </ProtectedRoute>
                  } 
                />
                ...
                <Route 
                  ...
                  element={
                    <ProtectedRoute roles={['inspector']}>
                      <ProfessionalRoute component={InspectionWorkflow} name="Inspection" />
                    </ProtectedRoute>
                  } 
                />
                ...
                <Route 
                  ...
                  element={
                    <ProtectedRoute roles={['inspector']}>
                      <ProfessionalRoute component={InspectionReports} name="Reports" />
                    </ProtectedRoute>
                  } 
                />
                ...
                <Route 
                  ...
                  element={
                    <ProtectedRoute roles={['admin']}>
                      <ProfessionalRoute component={AdminDashboard} name="Admin Dashboard" />
                    </ProtectedRoute>
                  } 
                />
                ...
                <Route 
                  ...
                  element={
                    <ProtectedRoute roles={['admin']}>
                      <ProfessionalRoute component={UserManagement} name="User Management" />
                    </ProtectedRoute>
                  } 
                />
                ...
                <Route 
                  ...
                  element={
                    <ProtectedRoute roles={['admin']}>
                      <ProfessionalRoute component={ChecklistManagement} name="Checklist Management" />
                    </ProtectedRoute>
                  } 
                />
                ...
                <Route 
                  ...
                  element={
                    <ProtectedRoute roles={['admin']}>
                      <ProfessionalRoute component={AuditCenter} name="Audit Center" />
                    </ProtectedRoute>
                  } 
                />
                ...
                <Route 
                  ...
                  element={
                    <ProtectedRoute roles={['auditor', 'admin']}>
                      <ProfessionalRoute component={AuditorDashboard} name="Auditor Dashboard" />
                    </ProtectedRoute>
                  } 
                />
                ...
                <Route 
                  path="*" 
                  element={<ProfessionalRoute component={NotFound} name="Not Found" />} 
                />
              </Routes>
